...
export function AddSaleModal({ isOpen, onClose }: AddSaleModalProps) {
	...
	// Filter sellable materials (Final and Semi-Finished)
	const sellableMaterials = useMemo(() => materials.filter(m => m.category === 'Final' || m.category === 'Semi-Finished'), [materials]);
		...
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			<div className="relative bg-white rounded-2xl shadow-xl max-w-3xl w-full mx-4 p-6 animate-scale-in max-h-[90vh] overflow-y-auto">
				...
				<div className="mb-6">
					...
					<p className="text-sm text-slate-600 mt-1">Enter sale details for buyer</p>
				</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						...
						<div className="md:col-span-2">
							...
							<input
								...
								placeholder="Optional notes (e.g. Invoice Number, Remarks)"
							/>
						</div>
					</div>
